...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        const argsUserController_handleDuplicateEmailTest: Record<string, TsoaRoute.ParameterSchema> = {
        };
        app.get('/users/duplicate-email-test',
            ...(fetchMiddlewares<RequestHandler>(UserController)),
            ...(fetchMiddlewares<RequestHandler>(UserController.prototype.handleDuplicateEmailTest)),

            async function UserController_handleDuplicateEmailTest(request: ExRequest, response: ExResponse, next: any) {
